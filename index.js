...
function closeModals() {
    ...
    //    var pantryModal = document.getElementById("reactModal");
    //    var pantryModal = document.getElementById("randomModal");

    window.onclick = function (event) {
        //        if (event.target == beerBellyModal || event.target == pantryModal) {
        //            document.get
        //        }
        switch (event.target) {
            case beerBellyModal:
